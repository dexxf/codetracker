...
public interface JpaActivityRepository extends JpaRepository<ActivityEntity, String> {
    ...
    @Query("""
    SELECT new com.io.kira.application.activity.result.StudentActivityOverviewData(
        a.activityId,
        a.title,
        a.description,
        a.maxScore,
    ...
    @Query("""
            SELECT new com.io.kira.application.classroom.result.ClassroomActivityCreatedData(
                a.activityId,
                a.title,
                a.createdAt
            )
